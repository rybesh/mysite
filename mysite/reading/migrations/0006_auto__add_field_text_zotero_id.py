...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Text.zotero_id'
        db.add_column('reading_text', 'zotero_id', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Text.zotero_id'
        db.delete_column('reading_text', 'zotero_id')
