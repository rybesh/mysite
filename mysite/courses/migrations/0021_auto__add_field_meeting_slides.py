...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.slides'
        db.add_column('courses_meeting', 'slides', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.slides'
        db.delete_column('courses_meeting', 'slides')
