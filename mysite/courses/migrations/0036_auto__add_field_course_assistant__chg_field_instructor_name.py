...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.assistant'
        db.add_column('courses_course', 'assistant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='courses_assisting', null=True, to=orm['courses.Instructor']), keep_default=False)

        # Changing field 'Instructor.name'
        db.alter_column('courses_instructor', 'name', self.gf('django.db.models.fields.CharField')(max_length=36))


    def backwards(self, orm):
        
        # Deleting field 'Course.assistant'
        db.delete_column('courses_course', 'assistant_id')

        # Changing field 'Instructor.name'
        db.alter_column('courses_instructor', 'name', self.gf('django.db.models.fields.CharField')(max_length=9))
    ...
    models = {
        ...
        'courses.course': {
            ...
            'assistant': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'courses_assisting'", 'null': 'True', 'to': "orm['courses.Instructor']"}),
