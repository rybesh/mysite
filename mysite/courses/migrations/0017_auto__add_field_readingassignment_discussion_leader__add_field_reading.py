...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReadingAssignment.discussion_leader'
        db.add_column('courses_readingassignment', 'discussion_leader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'ReadingAssignment.discussion_questions'
        db.add_column('courses_readingassignment', 'discussion_questions', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReadingAssignment.discussion_leader'
        db.delete_column('courses_readingassignment', 'discussion_leader_id')

        # Deleting field 'ReadingAssignment.discussion_questions'
        db.delete_column('courses_readingassignment', 'discussion_questions')
