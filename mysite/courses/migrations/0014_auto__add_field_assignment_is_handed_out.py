...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.is_handed_out'
        db.add_column('courses_assignment', 'is_handed_out', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.is_handed_out'
        db.delete_column('courses_assignment', 'is_handed_out')
