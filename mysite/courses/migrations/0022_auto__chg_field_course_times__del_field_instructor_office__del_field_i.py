...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.times'
        db.alter_column('courses_course', 'times', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Deleting field 'Instructor.office'
        db.delete_column('courses_instructor', 'office')

        # Deleting field 'Instructor.office_hours'
        db.delete_column('courses_instructor', 'office_hours')

        # Deleting field 'Instructor.phone'
        db.delete_column('courses_instructor', 'phone')

        # Deleting field 'Instructor.email'
        db.delete_column('courses_instructor', 'email')

        # Adding field 'Instructor.url'
        db.add_column('courses_instructor', 'url', self.gf('django.db.models.fields.URLField')(default='http://aeshin.org/', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Course.times'
        db.alter_column('courses_course', 'times', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Adding field 'Instructor.office'
        db.add_column('courses_instructor', 'office', self.gf('django.db.models.fields.CharField')(default='', max_length=12), keep_default=False)

        # Adding field 'Instructor.office_hours'
        db.add_column('courses_instructor', 'office_hours', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'Instructor.phone'
        db.add_column('courses_instructor', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=14), keep_default=False)

        # Adding field 'Instructor.email'
        db.add_column('courses_instructor', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Deleting field 'Instructor.url'
        db.delete_column('courses_instructor', 'url')
