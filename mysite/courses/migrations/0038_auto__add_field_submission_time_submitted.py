...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.time_submitted'
        db.add_column('courses_submission', 'time_submitted', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.time_submitted'
        db.delete_column('courses_submission', 'time_submitted')
    ...
    models = {
        ...
        'courses.submission': {
            ...
            'time_submitted': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
