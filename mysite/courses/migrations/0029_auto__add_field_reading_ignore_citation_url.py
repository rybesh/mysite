...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reading.ignore_citation_url'
        db.add_column('courses_reading', 'ignore_citation_url', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reading.ignore_citation_url'
        db.delete_column('courses_reading', 'ignore_citation_url')
