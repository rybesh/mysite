...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reading.zotero_id'
        db.add_column('courses_reading', 'zotero_id', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reading.zotero_id'
        db.delete_column('courses_reading', 'zotero_id')
