...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('courses_course', 'instructor', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='courses', to=orm['courses.Instructor']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.instructor'
        db.delete_column('courses_course', 'instructor_id')
