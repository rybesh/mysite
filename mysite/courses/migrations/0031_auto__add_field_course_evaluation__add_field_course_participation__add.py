...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.evaluation'
        db.add_column('courses_course', 'evaluation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Course.participation'
        db.add_column('courses_course', 'participation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Course.thanks'
        db.add_column('courses_course', 'thanks', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.evaluation'
        db.delete_column('courses_course', 'evaluation')

        # Deleting field 'Course.participation'
        db.delete_column('courses_course', 'participation')

        # Deleting field 'Course.thanks'
        db.delete_column('courses_course', 'thanks')
