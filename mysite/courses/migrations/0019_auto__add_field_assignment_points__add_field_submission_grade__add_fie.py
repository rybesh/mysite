...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('courses_assignment', 'points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Submission.grade'
        db.add_column('courses_submission', 'grade', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Submission.comments'
        db.add_column('courses_submission', 'comments', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.points'
        db.delete_column('courses_assignment', 'points')

        # Deleting field 'Submission.grade'
        db.delete_column('courses_submission', 'grade')

        # Deleting field 'Submission.comments'
        db.delete_column('courses_submission', 'comments')
