...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('courses_course', 'semester', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'Course.semester'
        db.alter_column('courses_course', 'semester', self.gf('django.db.models.fields.IntegerField')())
