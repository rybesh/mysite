...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reading.citation_text'
        db.add_column('courses_reading', 'citation_text', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'Reading.citation_html'
        db.add_column('courses_reading', 'citation_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reading.citation_text'
        db.delete_column('courses_reading', 'citation_text')

        # Deleting field 'Reading.citation_html'
        db.delete_column('courses_reading', 'citation_html')
    ...
    models = {
        ...
        'courses.reading': {
            ...
            'citekey': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '16', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
