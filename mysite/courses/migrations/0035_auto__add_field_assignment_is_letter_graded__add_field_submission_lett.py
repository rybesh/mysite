...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.is_letter_graded'
        db.add_column('courses_assignment', 'is_letter_graded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Submission.letter_grade'
        db.add_column('courses_submission', 'letter_grade', self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.is_letter_graded'
        db.delete_column('courses_assignment', 'is_letter_graded')

        # Deleting field 'Submission.letter_grade'
        db.delete_column('courses_submission', 'letter_grade')
