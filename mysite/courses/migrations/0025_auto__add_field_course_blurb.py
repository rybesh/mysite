...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.blurb'
        db.add_column('courses_course', 'blurb', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.blurb'
        db.delete_column('courses_course', 'blurb')
