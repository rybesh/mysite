...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('courses_submission', 'time_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 2, 28, 10, 9, 0, 476569)))


    def backwards(self, orm):
        
        # Changing field 'Submission.time_submitted'
        db.alter_column('courses_submission', 'time_submitted', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'courses.submission': {
            ...
            'time_submitted': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
