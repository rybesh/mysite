...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.is_graded'
        db.add_column('courses_assignment', 'is_graded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.is_graded'
        db.delete_column('courses_assignment', 'is_graded')
