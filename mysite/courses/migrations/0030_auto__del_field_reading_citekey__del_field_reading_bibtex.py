...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Reading.bibtex'
        db.delete_column('courses_reading', 'bibtex')


    def backwards(self, orm):
        
        # Adding field 'Reading.citekey'
        db.add_column('courses_reading', 'citekey', self.gf('django.db.models.fields.CharField')(default='', max_length=16, unique=True, blank=True), keep_default=False)

        # Adding field 'Reading.bibtex'
        db.add_column('courses_reading', 'bibtex', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
