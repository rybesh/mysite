...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Course.has_blog'
        db.delete_column('courses_course', 'has_blog')

        # Adding field 'Course.blog_slug'
        db.add_column('courses_course', 'blog_slug', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Course.has_blog'
        db.add_column('courses_course', 'has_blog', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Course.blog_slug'
        db.delete_column('courses_course', 'blog_slug')
