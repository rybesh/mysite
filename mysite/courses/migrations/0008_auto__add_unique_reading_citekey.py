...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Reading', fields ['citekey']
        db.create_unique('courses_reading', ['citekey'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Reading', fields ['citekey']
        db.delete_unique('courses_reading', ['citekey'])
