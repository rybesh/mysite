...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.ereserves_id'
        db.add_column('courses_course', 'ereserves_id', self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True), keep_default=False)

        # Adding field 'Reading.access_via_ereserves'
        db.add_column('courses_reading', 'access_via_ereserves', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.ereserves_id'
        db.delete_column('courses_course', 'ereserves_id')

        # Deleting field 'Reading.access_via_ereserves'
        db.delete_column('courses_reading', 'access_via_ereserves')
